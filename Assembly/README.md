...
9) Attach the Sensirion sensor to the transparent lid using double sided tape (provided). The footprint position for the sensor is indicated as a white line on the PCB. Please do *not* peel off the protective film around the Sensirion sensor. Close the lid using the 4 metalic screws and make sure you do not trap any cables.
